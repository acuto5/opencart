...
--
-- Host: 127.0.0.1
-- Generation Time: 2017 m. Rgp 01 d. 10:58
...
(1, 'Default', '', 1, '2017-07-30 23:59:23', '2017-07-30 23:59:23');
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.75677312, 1, '2017-08-01 10:25:10'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2017-08-01 10:25:10'),
(3, 'Euro', 'EUR', '', '€', '2', 0.84695520, 1, '2017-08-01 10:25:10');
...
(1, 1, 0, 0, 'Petras', 'b', 'as@as.as', '123', '', '6e31685e815b72e177c9f7860c26cf208ca997ae', 'adYBc2xzB', NULL, NULL, 0, 0, '[]', '', 1, 0, '', '', '2017-07-31 09:20:12'),
(2, 1, 0, 0, 'c', 'd', 'as@as.add', '53863', '', 'aa81408e9de7358c49b3f4a1029668541eb8b91b', 'Q9vDkZoOE', NULL, NULL, 0, 0, '[]', '', 1, 0, '', '', '2017-07-31 20:45:38');
...
--
-- Sukurta duomenų kopija lentelei `oc_customer_reward`
--

INSERT INTO `oc_customer_reward` (`customer_reward_id`, `customer_id`, `order_id`, `description`, `points`, `date_added`) VALUES
(2, 1, 0, 'apibudinimas', 555, '2017-07-31 12:01:44'),
(3, 1, 0, 'apibudinimas', 555, '2017-07-31 12:01:52');
...
--
-- Sukurta duomenų struktūra lentelei `oc_customer_special_prices`
--

CREATE TABLE `oc_customer_special_prices` (
  `id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
--
-- Sukurta duomenų kopija lentelei `oc_customer_special_prices`
--

INSERT INTO `oc_customer_special_prices` (`id`, `customer_id`, `ean`, `special_price`, `date_added`, `added_by`) VALUES
(102, 2, '999', '555', '2017-08-01 13:20:37', 1),
(101, 2, '321', '111', '2017-08-01 13:20:37', 1),
(104, 1, '321', '111', '2017-08-01 13:25:38', 2),
(103, 1, '123', '789', '2017-08-01 13:25:38', 2),
(100, 2, '123', '789', '2017-08-01 13:20:37', 1),
(105, 1, '999', '555', '2017-08-01 13:25:38', 2);
...
(29, 'Product 2', '', '', '999', '', '', '', '', 999, 6, 'catalog/demo/palm_treo_pro_1.jpg', 6, 1, '279.9900', 0, 9, '2009-02-03', '133.00000000', 2, '0.00000000', '0.00000000', '0.00000000', 3, 1, 1, 0, 1, 2, '2009-02-03 16:42:17', '2011-09-30 01:06:08'),
(30, 'Product 3', '', '', '321', '', '', '', '', 7, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 1, '100.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 2, '2009-02-03 16:59:00', '2017-07-31 12:34:24'),
...
(42, 'Product 155', '', '', '123', '', '', '', '', 990, 5, 'catalog/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 9, '2009-02-04', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 2, 0, 1, 6, '2009-02-03 21:07:37', '2017-07-31 12:33:59'),
...
--
-- Sukurta duomenų kopija lentelei `oc_product_to_layout`
--
...
('7a7057d729aef3eb8f9c9c26ff', '{"language":"en-gb","currency":"EUR","user_id":"2","user_token":"m6lQcXNn5W2BqABuCbkaINkEFPTZNKA5"}', '2017-08-01 10:51:05'),
('972acf2ad00f45031e9629dacf', '{"language":"en-gb","currency":"EUR","user_id":"1","user_token":"hvhhxtrSjL3KufHp178LVSm8zIhADdWL"}', '2017-07-30 22:45:28'),
('982344a63549bbef34e11e860f', '{"language":"en-gb","currency":"USD","user_id":"1","user_token":"kMHgFobqZ4tbjxvePvD5ACiCPDvwThIf"}', '2017-07-30 21:24:09');
...
(201, 0, 'config', 'config_email', 'acuto@inbox.lt', 0),
...
(202, 0, 'config', 'config_encryption', '', 0),
...
(223, 0, 'developer', 'developer_sass', '0', 0),
(222, 0, 'developer', 'developer_theme', '0', 0);
...
(1, 1, 'admin', '4eed79aa4be7e201061055155f238c0390ea0671', 'kv9h2g8MA', 'John', 'Doe', 'acuto@inbox.lt', '', '', '::1', 1, '2017-07-30 23:59:23'),
(2, 1, 'rrrrr', 'e57549ba3be3dd63740e5cbfc46f7809d94c3c94', 'nY9kAK3z1', 'rrrrr', 'rrrrr', 'r@r.r', '', '', '::1', 1, '2017-07-31 20:34:13');
...
--
-- Indexes for table `oc_customer_special_prices`
--
ALTER TABLE `oc_customer_special_prices`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `oc_customer_special_prices`
--
ALTER TABLE `oc_customer_special_prices`
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=224;
--
